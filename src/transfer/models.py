...
class Transfer(Base):
    ...
    from_account_id: Mapped[int] = mapped_column(sa.ForeignKey("account.id"), nullable=False)
    to_account_id: Mapped[int] = mapped_column(sa.ForeignKey("account.id"), nullable=False)
